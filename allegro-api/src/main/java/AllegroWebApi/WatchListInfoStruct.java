...
public class WatchListInfoStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.ItemsNotAddedStruct[] itemsNotAdded;
    ...
    public WatchListInfoStruct(
           long[] itemsAdded,
           AllegroWebApi.ItemsNotAddedStruct[] itemsNotAdded) {
     ...
     */
    public AllegroWebApi.ItemsNotAddedStruct[] getItemsNotAdded() {
        return itemsNotAdded;
    }
     ...
     * @param itemsNotAdded
     */
    public void setItemsNotAdded(AllegroWebApi.ItemsNotAddedStruct[] itemsNotAdded) {
        this.itemsNotAdded = itemsNotAdded;
    }
