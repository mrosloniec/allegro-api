...
public class PaymentSellersStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.PaymentItemsStruct[] payTransItems;
    ...
    public PaymentSellersStruct(
           ...
           AllegroWebApi.PaymentItemsStruct[] payTransItems,
     ...
     */
    public AllegroWebApi.PaymentItemsStruct[] getPayTransItems() {
        return payTransItems;
    }
     ...
     * @param payTransItems
     */
    public void setPayTransItems(AllegroWebApi.PaymentItemsStruct[] payTransItems) {
        this.payTransItems = payTransItems;
    }
