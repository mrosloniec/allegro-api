...
public class WatchItemStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.ItemReminderStruct[] itemReminder;
    ...
    public WatchItemStruct(
           ...
           int itemPayuInfo,
           AllegroWebApi.ItemReminderStruct[] itemReminder) {
           this.itemId = itemId;
     ...
     * @return itemReminder
     */
    public AllegroWebApi.ItemReminderStruct[] getItemReminder() {
        return itemReminder;
    }
     ...
     * @param itemReminder
     */
    public void setItemReminder(AllegroWebApi.ItemReminderStruct[] itemReminder) {
        this.itemReminder = itemReminder;
    }
