...
public class AllegroWebApiBindingStub extends org.apache.axis.client.Stub implements AllegroWebApi.AllegroWebApiPortType {
    ...
    private static void _initOperationDesc12(){
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "search-categories"), org.apache.axis.description.ParameterDesc.OUT, new javax.xml.namespace.QName("urn:AllegroWebApi", "ArrayOfCategoriesStruct"), AllegroWebApi.CategoriesStruct[].class, false, false);
        oper.addParameter(param);
        oper.setReturnType(org.apache.axis.encoding.XMLType.AXIS_VOID);
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
    ...
    private void addBindings0() {
            ...
            cachedSerQNames.add(qName);
            cls = AllegroWebApi.AdvertInfoStruct.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            cachedSerQNames.add(qName);
            cls = AllegroWebApi.CategoriesStruct[].class;
            cachedSerClasses.add(cls);
    ...
    private void addBindings2() {
            ...
            cachedSerQNames.add(qName);
            cls = AllegroWebApi.SellerInfoStruct.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {sessionHandle, searchQuery});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                searchCategories.value = (AllegroWebApi.CategoriesStruct[]) _output.get(new javax.xml.namespace.QName("", "search-categories"));
            } catch (java.lang.Exception _exception) {
                searchCategories.value = (AllegroWebApi.CategoriesStruct[]) org.apache.axis.utils.JavaUtils.convert(_output.get(new javax.xml.namespace.QName("", "search-categories")), AllegroWebApi.CategoriesStruct[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
