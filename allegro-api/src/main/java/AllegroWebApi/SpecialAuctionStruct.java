...
public class SpecialAuctionStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.AttribStruct[] itAttribsList;
    ...
    public SpecialAuctionStruct(
           ...
           AllegroWebApi.AttribStruct[] itAttribsList) {
           this.itId = itId;
           this.itName = itName;
     ...
     */
    public AllegroWebApi.AttribStruct[] getItAttribsList() {
        return itAttribsList;
    }
     ...
     * @param itAttribsList
     */
    public void setItAttribsList(AllegroWebApi.AttribStruct[] itAttribsList) {
        this.itAttribsList = itAttribsList;
    }
