...
public class ChangedItemStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.FieldsValue[] itemFields;

    private AllegroWebApi.ItemSurchargeStruct[] itemSurcharge;
    ...
    public ChangedItemStruct(
           long itemId,
           AllegroWebApi.FieldsValue[] itemFields,
           AllegroWebApi.ItemSurchargeStruct[] itemSurcharge) {
           this.itemId = itemId;
