...
public class ItemSurchargeStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.AmountStruct surchargeAmount;
    ...
    public ItemSurchargeStruct(
           ...
           AllegroWebApi.AmountStruct surchargeAmount) {
     ...
     */
    public AllegroWebApi.AmountStruct getSurchargeAmount() {
        return surchargeAmount;
    }
     ...
     */
    public void setSurchargeAmount(AllegroWebApi.AmountStruct surchargeAmount) {
        this.surchargeAmount = surchargeAmount;
    }
