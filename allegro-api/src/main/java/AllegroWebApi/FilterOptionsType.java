...
public class FilterOptionsType  implements java.io.Serializable {
    ...
    private AllegroWebApi.RangeValueType filterValueRange;
    ...
    public FilterOptionsType(
           ...
           AllegroWebApi.RangeValueType filterValueRange) {
     ...
     */
    public AllegroWebApi.RangeValueType getFilterValueRange() {
        return filterValueRange;
    }
     ...
     */
    public void setFilterValueRange(AllegroWebApi.RangeValueType filterValueRange) {
        this.filterValueRange = filterValueRange;
    }
