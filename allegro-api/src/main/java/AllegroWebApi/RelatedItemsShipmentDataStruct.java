...
public class RelatedItemsShipmentDataStruct  implements java.io.Serializable {
    private AllegroWebApi.SellerShipmentDataStruct[] sellerShipmentData;

    public RelatedItemsShipmentDataStruct() {
    }

    public RelatedItemsShipmentDataStruct(
           AllegroWebApi.SellerShipmentDataStruct[] sellerShipmentData) {
     ...
     */
    public AllegroWebApi.SellerShipmentDataStruct[] getSellerShipmentData() {
        return sellerShipmentData;
    }
     ...
     */
    public void setSellerShipmentData(AllegroWebApi.SellerShipmentDataStruct[] sellerShipmentData) {
        this.sellerShipmentData = sellerShipmentData;
    }
