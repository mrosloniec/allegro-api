...
public class SellerPaymentInfoStruct  implements java.io.Serializable {
    private AllegroWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza;

    private AllegroWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza;

    public SellerPaymentInfoStruct() {
    }

    public SellerPaymentInfoStruct(
           AllegroWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza,
           AllegroWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza) {
     ...
     */
    public AllegroWebApi.ShipmentPaymentInfoStruct[] getShipmentPaymentInfoPza() {
        return shipmentPaymentInfoPza;
    }
     ...
     */
    public void setShipmentPaymentInfoPza(AllegroWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoPza) {
        this.shipmentPaymentInfoPza = shipmentPaymentInfoPza;
    }
     ...
     */
    public AllegroWebApi.ShipmentPaymentInfoStruct[] getShipmentPaymentInfoNonPza() {
        return shipmentPaymentInfoNonPza;
    }
     ...
     */
    public void setShipmentPaymentInfoNonPza(AllegroWebApi.ShipmentPaymentInfoStruct[] shipmentPaymentInfoNonPza) {
        this.shipmentPaymentInfoNonPza = shipmentPaymentInfoNonPza;
    }
