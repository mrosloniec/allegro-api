...
public class ShipmentDataStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.ShipmentTimeStruct shipmentTime;
    ...
    public ShipmentDataStruct(
           ...
           int shipmentType,
           AllegroWebApi.ShipmentTimeStruct shipmentTime) {
     ...
     * @return shipmentTime
     */
    public AllegroWebApi.ShipmentTimeStruct getShipmentTime() {
        return shipmentTime;
    }
     ...
     * @param shipmentTime
     */
    public void setShipmentTime(AllegroWebApi.ShipmentTimeStruct shipmentTime) {
        this.shipmentTime = shipmentTime;
    }
