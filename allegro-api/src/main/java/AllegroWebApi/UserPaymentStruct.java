...
public class UserPaymentStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.PaymentSellersStruct[] payTransSellers;
    ...
    public UserPaymentStruct(
           long payTransId,
           AllegroWebApi.PaymentSellersStruct[] payTransSellers,
     ...
     */
    public AllegroWebApi.PaymentSellersStruct[] getPayTransSellers() {
        return payTransSellers;
    }
     ...
     */
    public void setPayTransSellers(AllegroWebApi.PaymentSellersStruct[] payTransSellers) {
        this.payTransSellers = payTransSellers;
    }
